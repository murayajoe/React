...
const BlogPagePage = () => {
  return (
    <>
      <div className="bg-black-900_01 flex flex-col items-center justify-start mx-auto w-full">
        <div className="bg-black-900_01 flex flex-col items-center justify-start w-full">
          <header className="flex flex-col font-gilroy items-center justify-center md:px-5 w-full">
            <div className="border-b border-blue_gray-900_01 border-solid flex md:flex-col flex-row md:gap-10 items-center justify-between p-[17px] w-full">
              ...
              <div className="flex flex-row gap-6 sm:hidden items-start justify-start w-auto">
          ...
          >
            ...
            <span className="text-blue_gray-50 tracking-[0.12px] font-gilroy text-left font-bold">
              Writing
            </span>
          </Text>
          <Text
            className="mt-[43px] sm:text-[38px] md:text-[44px] text-[52px] text-gray-50"
            size="txtGilroySemiBold52Gray50"
          >
          ...
          <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between max-w-[981px] mt-[62px] mx-auto md:px-5 w-full">
            <div className="flex sm:flex-1 flex-row font-gilroy gap-4 items-center justify-between w-[27%] sm:w-full">
              ...
              <div className="flex flex-col gap-[5px] items-start justify-start">
                <Text
                  className="text-2xl md:text-[22px] text-blue_gray-50 text-center sm:text-xl"
                  size="txtGilroySemiBold24Bluegray50"
                >
                  By Jane Phillips
                </Text>
                <Text
                  className="text-blue_gray-100 text-center text-sm"
                  size="txtGilroyRegular14Bluegray100"
                >
                  12 September, 2020
                </Text>
              </div>
            ...
            <Button
              ...
              leftIcon={
                <Img
                  ...
                  src="images/img_share_outline_blue_gray_50.svg"
                  alt="share/Outline"
                />
              }
              color="blue_gray_50"
          ...
          <div className="flex flex-col items-start justify-start max-w-[980px] mt-14 mx-auto md:px-5 w-full">
            <Text
              className="leading-[35.00px] text-blue_gray-100 text-lg w-full"
              size="txtGilroyMedium18Bluegray100"
            >
            ...
            <Text
              className="leading-[35.00px] mt-7 text-blue_gray-100 text-lg w-full"
              size="txtPublicSansLight18Bluegray100"
            >
              <span className="text-blue_gray-100 font-gilroy text-left font-medium">
            ...
            <Text
              className="leading-[35.00px] mt-[50px] text-blue_gray-100 text-lg w-full"
              size="txtGilroyMedium18Bluegray100"
            >
            ...
            <div className="flex flex-col font-gilroy items-start justify-start md:ml-[0] ml-[31px] mt-7 w-[44%] md:w-full">
              <div className="flex flex-row gap-[15px] items-start justify-start w-3/5 md:w-full">
                <div className="bg-blue_gray-100 h-2.5 mb-[7px] mt-1 rounded-[50%] w-2.5"></div>
                <Text
              ...
              <div className="flex flex-row gap-[15px] items-center justify-start mt-3 w-[82%] md:w-full">
                <div className="bg-blue_gray-100 h-2.5 my-[5px] rounded-[50%] w-2.5"></div>
                <Text
                  className="text-blue_gray-100 text-lg"
                  size="txtGilroyMedium18Bluegray100"
                >
              ...
              <div className="flex sm:flex-col flex-row gap-[15px] items-start justify-start mt-[15px] w-full">
                <div className="bg-blue_gray-100 h-2.5 mb-[7px] sm:mt-0 mt-1 rounded-[50%] w-2.5"></div>
                <Text
                  className="text-blue_gray-100 text-lg"
                  size="txtGilroyMedium18Bluegray100"
                >
            ...
            <Text
              className="leading-[35.00px] mt-[33px] text-blue_gray-100 text-lg w-full"
              size="txtGilroyMedium18Bluegray100"
            >
              Could someone survive inside a transporter buffer for 75 years?
              Fate. It protects fools, little children, and ships named
          ...
          <div className="flex flex-col font-gilroy gap-3 items-start justify-start mt-[41px] md:px-5 w-[35%] md:w-full">
            <Text
              className="text-2xl md:text-[22px] text-blue_gray-50 sm:text-xl"
              size="txtGilroyMedium24Bluegray50"
            >
              Tags
            </Text>
          ...
          <div className="flex flex-row font-gilroy gap-4 items-center justify-center mt-[66px] md:px-5 w-[18%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start">
              ...
              <Text
                className="mt-1 text-blue_gray-100 text-sm"
                size="txtGilroyRegular14Bluegray100"
              >
                UX Researcher
              </Text>
          ...
          <div className="flex flex-col font-gilroy gap-[35px] items-start justify-start max-w-[1077px] mt-[118px] mx-auto md:px-5 w-full">
            <Text
              ...
              size="txtGilroySemiBold28Gray50"
            >
              More Like these
            </Text>
            <List
            ...
            >
              <div className="bg-gray-900_06 border border-blue_gray-900_01 border-solid flex flex-col gap-4 h-[533px] md:h-auto items-end justify-start p-2.5 rounded-[23px] w-[343px]">
                <Img
          ...
          <div className="bg-gray-900_01 flex flex-col font-gilroy gap-6 items-start justify-end mt-[120px] p-7 sm:px-5 w-full">
